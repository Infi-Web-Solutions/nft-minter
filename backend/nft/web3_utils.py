...
class NFTMarketplaceWeb3:
    def __init__(self):
        ...
        self.sepolia_url = os.getenv('ALCHEMY_API_URL', "https://eth-sepolia.g.alchemy.com/v2/Bxo3zUQluKPV1Z9k0ajGE")
        self.contract_address = os.getenv('NFT_CONTRACT_ADDRESS', "0xAB6FEdb0AdB537166425fd2bBd1F416b99899201")
